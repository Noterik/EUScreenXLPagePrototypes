$(document).ready(function () {
    ...
    EUScreenXL.PasswordResetPage = function () {
    ...
    EUScreenXL.PasswordResetPage.prototype = Object.create(EUScreenXL.Page.prototype);
    EUScreenXL.PasswordResetPage.prototype.searchButton = jQuery("#searchbutton");
    EUScreenXL.PasswordResetPage.prototype.menuButton = jQuery("#menubutton");
    EUScreenXL.PasswordResetPage.prototype.name = "passwordreset";
    EUScreenXL.PasswordResetPage.prototype.events = {
    ...
    new EUScreenXL.PasswordResetPage();
});
